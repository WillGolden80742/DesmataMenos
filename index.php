...
<head>
    ...
    <style id='styleTable'>
        <?php           
            $lines_array = file("assets/css/styles.css"); 
        ...
        <div id="mainContent">
            ...
            <div id="estateMap" class="estateMap" >
                    ...
                    <svg version="1.1" id="svg-map" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="100%" viewBox="0 0 450 460" enable-background="new 0 0 450 460" xml:space="preserve">
                        <g>
                        <a onclick="selectMap('estado_tocantins');" id="estado_tocantins" xlink:href="#tocantins" >
                        ...
                        <a onclick="selectMap('estado_bahia');" id="estado_bahia" xlink:href="#bahia">
                        <title>Bahia</title>
                        ...
                        <a onclick="selectMap('estado_sergipe');" id="estado_sergipe" xlink:href="#sergipe">
                        <title>Sergipe</title>
                        ...
                        <a onclick="selectMap('estado_pernambuco');" id="estado_pernambuco" xlink:href="#pernambuco">
                        ...
                        <a onclick="selectMap('estado_alagoas');" id="estado_alagoas" xlink:href="#alagoas">
                        <title>Alagoas</title>
                        ...
                        <a onclick="selectMap('estado_rio_grande_do_norte');" id="estado_rio_grande_do_norte" xlink:href="#riograndedonorte">
                        ...
                        <a onclick="selectMap('estado_ceara');" id="estado_ceara" xlink:href="#ceara">
                        <title>Ceará</title>
                        ...
                        <a onclick="selectMap('estado_piaui');" id="estado_piaui" xlink:href="#piaui">
                        <title>Piauí</title>
                        ...
                        <a onclick="selectMap('estado_maranhao');" id="estado_maranhao" xlink:href="#maranhao">
                        ...
                        <a onclick="selectMap('estado_amapa');" id="estado_amapa" xlink:href="#amapa">
                        <title>Amapá</title>
                        ...
                        <a onclick="selectMap('estado_para');" id="estado_para" xlink:href="#para">
                        <title>Pará</title>
                        ...
                        <a onclick="selectMap('estado_roraima');" id="estado_roraima" xlink:href="#roraima">
                        <title>Roraima</title>
                        ...
                        <a onclick="selectMap('estado_amazonas');" id="estado_amazonas" xlink:href="#amazonas">
                        ...
                        <a onclick="selectMap('estado_acre');" id="estado_acre" xlink:href="#acre">
                        <title>Acre</title>
                        ...
                        <a onclick="selectMap('estado_rondonia');" id="estado_rondonia" xlink:href="#rondonia">
                        ...
                        <a onclick="selectMap('estado_mato_grosso');" id="estado_mato_grosso" xlink:href="#matogrosso">
                        ...
                        <a onclick="selectMap('estado_mato_grosso_do_sul');" id="estado_mato_grosso_do_sul" xlink:href="#matogrossodosul">
                        ...
                        <a onclick="selectMap('estado_goias');" id="estado_goias" xlink:href="#goias">
                        <title>Goiás</title>
                        ...
                        <a onclick="selectMap('estado_parana');" id="estado_parana" xlink:href="#parana">
                        <title>Paraná</title>
                        ...
                        <a onclick="selectMap('estado_santa_catarina');" id="estado_santa_catarina" xlink:href="#santacatarina">
                        ...
                        <a onclick="selectMap('estado_rio_grande_do_sul');" id="estado_rio_grande_do_sul" xlink:href="#riograndedosul">
                        ...
                        <a onclick="selectMap('estado_sao_paulo');" id="estado_sao_paulo" xlink:href="#saopaulo">
                        ...
                        <a onclick="selectMap('estado_minas_gerais');" id="estado_minas_gerais" xlink:href="#minasgerais">
                        ...
                        <a onclick="selectMap('estado_rio_de_janeiro');" id="estado_rio_de_janeiro" xlink:href="#riodejaneiro">
                        ...
                        <a onclick="selectMap('estado_espirito_santo');" id="estado_espirito_santo" xlink:href="#espiritosanto">
                        ...
                        <a onclick="selectMap('estado_distrito_federal');" id="estado_distrito_federal" xlink:href="#distritofederal">
                        ...
                        <a onclick="selectMap('estado_paraiba');" id="estado_paraiba" xlink:href="#paraiba">
                        <title>Paraíba</title>
