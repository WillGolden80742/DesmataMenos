...
<head>
    ...
    <body>
        <center style="border:none;">
            <div class="mailFrame" id="mailFrame" style="display:none;">
                <input type="" id="email" value="" placeholder="example@mail.com">
        ...
        <div id="mainContent">
            <div class="select_stateDIV" >
                ...
                <select id="select_state" class="select_state" onchange="dados();">
                </select>
                ...
                <select id="select_mail" class="select_mail"  onchange="mailFrame(true);">
            ...
            <div id="estateMap" class="estateMap" >
                    ...
                    <svg version="1.1" id="svg-map" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="100%" viewBox="0 0 450 460" enable-background="new 0 0 450 460" xml:space="preserve">
                        <g>
                        <a onclick="selectMap('tocantins');" id="tocantins" xlink:href="#tocantins" >
                        ...
                        <a onclick="selectMap('bahia');" id="bahia" xlink:href="#bahia">
                        <title>Bahia</title>
                        ...
                        <a onclick="selectMap('sergipe');" id="sergipe" xlink:href="#sergipe">
                        <title>Sergipe</title>
                        ...
                        <a onclick="selectMap('pernambuco');" id="pernambuco" xlink:href="#pernambuco">
                        ...
                        <a onclick="selectMap('alagoas');" id="alagoas" xlink:href="#alagoas">
                        <title>Alagoas</title>
                        ...
                        <a onclick="selectMap('rio_grande_do_norte');" id="rio_grande_do_norte" xlink:href="#riograndedonorte">
                        ...
                        <a onclick="selectMap('ceara');" id="ceara" xlink:href="#ceara">
                        <title>Ceará</title>
                        ...
                        <a onclick="selectMap('piaui');" id="piaui" xlink:href="#piaui">
                        <title>Piauí</title>
                        ...
                        <a onclick="selectMap('maranhao');" id="maranhao" xlink:href="#maranhao">
                        ...
                        <a onclick="selectMap('amapa');" id="amapa" xlink:href="#amapa">
                        <title>Amapá</title>
                        ...
                        <a onclick="selectMap('para');" id="para" xlink:href="#para">
                        <title>Pará</title>
                        ...
                        <a onclick="selectMap('roraima');" id="roraima" xlink:href="#roraima">
                        <title>Roraima</title>
                        ...
                        <a onclick="selectMap('amazonas');" id="amazonas" xlink:href="#amazonas">
                        ...
                        <a onclick="selectMap('acre');" id="acre" xlink:href="#acre">
                        <title>Acre</title>
                        ...
                        <a onclick="selectMap('rondonia');" id="rondonia" xlink:href="#rondonia">
                        ...
                        <a onclick="selectMap('mato_grosso');" id="mato_grosso" xlink:href="#matogrosso">
                        ...
                        <a onclick="selectMap('mato_grosso_do_sul');" id="mato_grosso_do_sul" xlink:href="#matogrossodosul">
                        ...
                        <a onclick="selectMap('goias');" id="goias" xlink:href="#goias">
                        <title>Goiás</title>
                        ...
                        <a onclick="selectMap('parana');" id="parana" xlink:href="#parana">
                        <title>Paraná</title>
                        ...
                        <a onclick="selectMap('santa_catarina');" id="santa_catarina" xlink:href="#santacatarina">
                        ...
                        <a onclick="selectMap('rio_grande_do_sul');" id="rio_grande_do_sul" xlink:href="#riograndedosul">
                        ...
                        <a onclick="selectMap('sao_paulo');" id="sao_paulo" xlink:href="#saopaulo">
                        ...
                        <a onclick="selectMap('minas_gerais');" id="minas_gerais" xlink:href="#minasgerais">
                        ...
                        <a onclick="selectMap('rio_de_janeiro');" id="rio_de_janeiro" xlink:href="#riodejaneiro">
                        ...
                        <a onclick="selectMap('espirito_santo');" id="espirito_santo" xlink:href="#espiritosanto">
                        ...
                        <a onclick="selectMap('distrito_federal');" id="distrito_federal" xlink:href="#distritofederal">
                        ...
                        <a onclick="selectMap('paraiba');" id="paraiba" xlink:href="#paraiba">
                        <title>Paraíba</title>
